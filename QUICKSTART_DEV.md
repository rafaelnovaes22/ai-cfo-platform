...
templates/                 # Templates Forge (aios, cicd, spec, economics)
docs/
...
- **SHADOW antes de cobrar** — nenhuma análise chega ao cliente sem `/acme:promote` validando o modo
