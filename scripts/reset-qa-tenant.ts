...
//   tsx --env-file=.env scripts/reset-qa-tenant.ts --email=qa+teste@aicfo.com.br
//   tsx --env-file=.env scripts/reset-qa-tenant.ts --email=qa+teste@aicfo.com.br --confirm
