  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        positive: { DEFAULT: "hsl(var(--positive))", soft: "hsl(var(--positive-soft))", foreground: "hsl(var(--positive-foreground))" },
        negative: { DEFAULT: "hsl(var(--negative))", soft: "hsl(var(--negative-soft))", foreground: "hsl(var(--negative-foreground))" },
