---
case_id: "action-planning-0001"
module: "monthly-analysis/action-planning"
outcome: "plan_by_horizon"
source_mode: "real"
priority: "P0"
created_at: "2026-05-20"
---

# Case action-planning-0001 — Plano de crescimento para varejo saudável

## Input

```yaml
dre_and_diagnostics: "margemLiquida=15; receitaBruta=10000000; comercial+8%"
narrativeCards:
  - type: critical_gap
...
judge_criteria:
  ...
  impacto_plausivel: "Ações de expansão/otimização; ≥3 short, ≥1 medium, ≥1 long; impacto plausível <=20% receita."
