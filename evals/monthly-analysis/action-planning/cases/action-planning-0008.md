...
# Case action-planning-0008 — Folha crescendo acima da receita

## Input

```yaml
dre_and_diagnostics: "pessoalShare=34%; variacaoPessoal=19%; variacaoReceita=3%"
narrativeCards:
  - type: critical_gap
...
judge_criteria:
  ...
  impacto_plausivel: "Ações de produtividade, metas e alocação; não recomendar demissão automática."
