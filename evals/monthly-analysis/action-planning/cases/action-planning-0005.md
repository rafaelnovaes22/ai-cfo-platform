---
case_id: "action-planning-0005"
module: "monthly-analysis/action-planning"
outcome: "risk_mitigation_plan"
source_mode: "synthetic"
priority: "P0"
created_at: "2026-05-20"
---

# Case action-planning-0005 — Receita concentrada em um cliente

## Input

```yaml
dre_and_diagnostics: "topClienteShare=0.62; margemLiquida=12"
narrativeCards:
  - type: critical_gap
...
judge_criteria:
  ...
  impacto_plausivel: "Ações de diversificação comercial e contratos; horizonte long para redução de dependência."
