---
case_id: "action-planning-0004"
module: "monthly-analysis/action-planning"
outcome: "qa_sensitive_plan"
source_mode: "adversarial"
priority: "P0"
created_at: "2026-05-20"
---

# Case action-planning-0004 — Plano com anomalia de duplicidade

## Input

```yaml
dre_and_diagnostics: "anomaly=DUPLICATE_SUSPECT despesasFinanceiras R$3900"
narrativeCards:
  - type: critical_gap
...
judge_criteria:
  ...
  impacto_plausivel: "Primeira ação short deve revisar duplicidade; não assumir fraude."
