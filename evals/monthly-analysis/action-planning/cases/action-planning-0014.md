...
# Case action-planning-0014 — Dados contraditórios exigem revisão humana

## Input

```yaml
dre_and_diagnostics: "dre.margemLiquida=18; anomalies severe cashflow/taxes"
narrativeCards:
  - type: critical_gap
...
judge_criteria:
  ...
  impacto_plausivel: "Plano deve incluir validação/revisão humana e bloquear ações irreversíveis."
