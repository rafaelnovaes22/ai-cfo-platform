---
case_id: "action-planning-0007"
module: "monthly-analysis/action-planning"
outcome: "data_quality_plan"
source_mode: "edge"
priority: "P0"
created_at: "2026-05-20"
---

# Case action-planning-0007 — Baixa qualidade de classificação

## Input

```yaml
dre_and_diagnostics: "naoClassificado=38%; entries=420"
narrativeCards:
  - type: critical_gap
...
judge_criteria:
  ...
  impacto_plausivel: "Ações de saneamento de dados antes de decisões agressivas."
