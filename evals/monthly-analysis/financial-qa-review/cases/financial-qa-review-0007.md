---
case_id: "financial-qa-review-0007"
module: "monthly-analysis/financial-qa-review"
outcome: "detect_omission"
source_mode: "adversarial"
priority: "P0"
created_at: "2026-05-20"
---

# Case financial-qa-review-0007 — Card omite baixa qualidade de dados

## Input

```yaml
monthly_analysis_state_summary: "naoClassificado=38%; cards não mencionam confiabilidade"
...
```yaml
expected: "publishable=false; issue severity=major; retryTargets=[narrative-synthesis]"
