---
case_id: "financial-qa-review-0005"
module: "monthly-analysis/financial-qa-review"
outcome: "detect_review_need"
source_mode: "adversarial"
priority: "P0"
created_at: "2026-05-20"
---

# Case financial-qa-review-0005 — Ação irreversível sem revisão em dados contraditórios

## Input

```yaml
monthly_analysis_state_summary: "anomalies severe; action manda demitir 30% imediatamente"
...
```yaml
expected: "publishable=false; blocker; retryTargets=[action-planning]"
