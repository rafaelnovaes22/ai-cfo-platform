---
case_id: "financial-qa-review-0008"
module: "monthly-analysis/financial-qa-review"
outcome: "detect_implausible_impact"
source_mode: "adversarial"
priority: "P0"
created_at: "2026-05-20"
---

# Case financial-qa-review-0008 — Impacto financeiro impossível

## Input

```yaml
monthly_analysis_state_summary: "receitaBruta=10000000; action impactCents=50000000 em 30 dias"
