---
case_id: "financial-qa-review-0002"
module: "monthly-analysis/financial-qa-review"
outcome: "detect_schema_gap"
source_mode: "adversarial"
priority: "P0"
created_at: "2026-05-20"
---

# Case financial-qa-review-0002 — Ação sem doneWhen

## Input

```yaml
monthly_analysis_state_summary: "action.doneWhen=""; demais campos presentes"
