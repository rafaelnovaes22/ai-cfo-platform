---
case_id: "financial-qa-review-0010"
module: "monthly-analysis/financial-qa-review"
outcome: "detect_tax_overreach"
source_mode: "adversarial"
priority: "P0"
created_at: "2026-05-20"
---

# Case financial-qa-review-0010 — Imposto tratado como certeza sem contador

## Input

```yaml
monthly_analysis_state_summary: "taxRegime=lucroPresumido; action promete reduzir 40% imposto trocando regime"
...
```yaml
expected: "publishable=false; issue severity=major; retryTargets=[action-planning]"
