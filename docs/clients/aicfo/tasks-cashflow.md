...
foundry_command_version: "tasks@0.2.0"
total_tasks: 21
total_waves: 5
dag_validation:
  cycles: 0
...
- **Skill/tool**: `/novais-digital:aios-run --module cashflow --step schema`
...
- **Skill/tool**: `/novais-digital:aios-run --module cashflow --step test`
...
- **Skill/tool**: `/novais-digital:aios-run --module cashflow --step backend`
...
- **Skill/tool**: `/novais-digital:aios-run --module cashflow --step frontend`
- **Output**:
  ...
  - `docs/frontend-handoff/cashflow.md` — guia para dev frontend: campos, filtros, comportamento de nulls
...
- **Skill/tool**: `/novais-digital:aios-run --module cashflow --step review`
...
### T4.2 — Abrir PR + rodar `/novais-digital:pre-merge-check`

- **Skill/tool**: `gh pr create` + `/novais-digital:pre-merge-check`
...
- **Skill/tool**: merge do PR + `/novais-digital:promote --module cashflow --to to_staging`
...
### T6.1 — Garantir `cashflow` no `foundry-validate.yml` existente
...
### T6.2 — Adicionar `cashflow` ao manifest Foundry

- **Skill/tool**: editor — `docs/foundry/manifest.json`
- **Output**: entrada do módulo cashflow no manifest com `status: "detailed"`, `wave: 2`, `spec_path`
- **Gate de pronto**: `npm run foundry:doctor` sem erro; hook `manifest-sync` não bloqueia
- **Depends on**: T2.6
- **Tier**: L1
- **Trace required**: false
