...
| **CANONICAL** | `pilot-state.md` mostra ≥14d em PILOT + zero incidente cross-tenant | — | promoção via `/novais-digital:promote` |
...
- [x] Próximo passo: `/novais-digital:tasks --artifact_id=cashflow`
...
**Próximo passo:** `/novais-digital:tasks --artifact_id=cashflow --client_id=aicfo`
