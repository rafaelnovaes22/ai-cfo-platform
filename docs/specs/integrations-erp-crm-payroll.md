...
**Status atual: stub** — spec detalhada será gerada via `/novais-digital:spec --module integrations-erp-crm-payroll` quando este módulo entrar em desenvolvimento (Onda 4).
