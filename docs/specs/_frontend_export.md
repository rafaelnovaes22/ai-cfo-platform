        ...
        "401":
          ...
          content:
            application/problem+json:
              ...
              example:
                type: "https://aicfo.com.br/errors/unauthorized"
          ...
          content:
            application/problem+json:
              schema:
                $ref: "#/components/schemas/ProblemDetail"
              example:
                type: "https://aicfo.com.br/errors/forbidden"
                title: "Acesso negado"
                status: 403
          ...
          content:
            application/problem+json:
              schema:
                $ref: "#/components/schemas/ProblemDetail"
              example:
                type: "https://aicfo.com.br/errors/not-found"
          ...
          content:
            application/problem+json:
              schema:
                $ref: "#/components/schemas/ProblemDetail"
              example:
                type: "https://aicfo.com.br/errors/unprocessable"
