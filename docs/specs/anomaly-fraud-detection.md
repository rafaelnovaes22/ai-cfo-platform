...
**Status atual: stub** — spec detalhada será gerada via `/novais-digital:spec --module anomaly-fraud-detection` quando este módulo entrar em desenvolvimento (Onda 7).
