    ...
    ProblemDetail:
      ...
      properties:
        type:
          ...
          example: "https://api.aicfo.com.br/errors/validation-error"
        title:
          type: string
        ...
        instance:
          ...
          example: "https://api.aicfo.com.br/errors/f47ac10b"
        requestId:
          type: string
          format: uuid
        ...
        "400":
          ...
          content:
            application/json:
              ...
              example:
                type: "https://api.aicfo.com.br/errors/missing-param"
                title: "Missing Required Parameter"
                status: 400
                detail: "Query ?referenceMonth=YYYY-MM obrigatório."
                instance: "https://api.aicfo.com.br/errors/d1d2d3d4"
...
```json
{
  "type": "https://api.aicfo.com.br/errors/validation-error",
  "title": "Validation Error",
  "status": 400,
  "detail": "O campo text precisa ter ao menos 10 caracteres.",
  "instance": "https://api.aicfo.com.br/errors/g1g2g3g4",
...
```json
{
  ...
  "instance": "https://api.aicfo.com.br/errors/h1h2h3h4",
