...
Regras presentes na spec `docs/specs/hub.md` (status: **stub**) que **não viraram teste neste plano** — exigirão expansão quando a spec for detalhada via `/novais-digital:spec --module hub`:
