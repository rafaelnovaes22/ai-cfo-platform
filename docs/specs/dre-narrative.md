...
- Promoção SHADOW → ASSISTED → AUTONOMOUS controlada por `/novais-digital:promote` (não por flag manual)
...
Execução via `/novais-digital:eval --module dre-narrative --model gemini-2.5-flash`.
