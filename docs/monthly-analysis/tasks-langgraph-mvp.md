...
Não bloqueia merge das tasks — pode ir em onda separada. Mas sem isso, `/novais-digital:promote` pra ASSISTED bloqueia (Gate 4).
...
- Avaliação de qualidade ASSISTED-ready — fica nos evals (Gate 4 do `/novais-digital:promote`)
