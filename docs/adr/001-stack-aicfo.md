...
Aicfo é um produto self-serve do guarda-chuva Acme. Backend e frontend React compartilham o mesmo monorepo (integrado em 2026-05-14, ADR-006). O backend serve a API REST e o frontend é buildado separadamente (Railway serviço dedicado).
...
| Observability | LangSmith 0.7+ | Obrigatório por C6; padrão Acme |
