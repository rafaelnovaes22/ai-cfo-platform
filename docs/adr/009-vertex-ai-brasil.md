...
**Problema bloqueador para primeiro cliente real**: AI Studio usa data center US (multi-region), sem garantia de residência de dados no Brasil. Política LGPD da Novais Digital (linked_principle C6) exige que dados de clientes PME brasileiros não saiam do território nacional sem autorização explícita.
