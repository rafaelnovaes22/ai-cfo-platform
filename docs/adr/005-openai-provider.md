...
Durante a sessão de validação do runner físico do `/novais-digital:eval` (2026-05-14), comparamos 8 modelos LLM contra os 32 cases do eval suite de `classification`:
...
- Eval suite passa o Gate 4 do `/novais-digital:promote` para `classification` (em ledger_classified)
