...
Override local do template canônico do agent-governance-framework (Foundry v0.6.0+).
...
1) **OpenAPI 3.1 spec completo do módulo**
   ...
   - Servers: declarar `https://api.example.com/v1` (prod) e `http://localhost:3000/v1` (dev)
...
class FrontendAgent(BaseAgent):
    agent_name = "anomaly-fraud-detection_frontend_agent"
