...
> Log append-only de transições de modo do SKU `monthly-analysis`. Cada transição registra os 6 gates do `/novais-digital:promote` com `signature_hash` dos aprovadores e referência aos artifacts validados. Auditável pelo reviewer DeepAgent na auditoria mensal.
...
gates:
  ...
  human_approval:
    ...
    bypass_note: "Bypass 'founder-solo-pre-team' da Transition 1 EXPIROU — the CEO (CEO) e dev frontend (dev) agora no time. Aprovação cruzada real com roles distintos."
    po:
      name: "Rafael Novaes"
...
recommendation: "ASSISTED: cliente recebe a análise e pode editar/comentar antes de fechar o mês. Monitorar agreement e custo via /novais-digital:audit-monthly. assisted→autonomous permanece bloqueado (≥30d em assisted + Gate 6 CI/CD + assinatura security-privacy-guardian)."

trace_id: "trace-promote-2026-06-29-shadow-assisted"
approved_at: "2026-06-29T00:00:00.000Z"
approved_by_signature: "3f6ec5d52d4e414b+f21817419a3743b2"
generated_by: "/novais-digital:promote shadow_to_assisted — sessão Claude Opus 4.8"
```
...
gates:
  ...
  human_approval:
    passed: true
    bypass_engaged: true
    bypass_flag: "NOVAIS_FOUNDRY_BYPASS=incident:founder-solo-pre-team"
...
recommendation: "monitorar dashboards de qualidade durante a janela SHADOW (14 dias min). Recrutar 5-10 PMEs reais. Rafael revisa TODA análise antes do cliente ver. Disparar /novais-digital:audit-monthly em 2026-06-25."

trace_id: "trace-77aa43ba9a5877c6"
approved_at: "2026-05-25T20:50:00.000Z"
approved_by_signature: "78df9d8d39f37805+61a108e924f7ddeb"
generated_by: "/novais-digital:promote@0.3.0 invocado em sessão Claude Sonnet 4.6"
```
